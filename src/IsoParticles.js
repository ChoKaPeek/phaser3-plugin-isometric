...
export default class IsoParticles extends Particles {
     ...
     * @param {number} x - The x coordinate (in 3D space) to position the IsoParticles at.
     * @param {number} y - The y coordinate (in 3D space) to position the IsoParticles at.
